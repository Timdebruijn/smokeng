...
func TestEveryRouteIsClassified(t *testing.T) {
	...
	want := map[string]routeClass{
		...
		"POST /api/v1/alerts/ack":                  classScopedWrite,
		"GET /api/v1/alert-baselines":              classScopedRead,
		"POST /api/v1/alert-rules/{id}/baseline":   classScopedWrite,
		"DELETE /api/v1/alert-rules/{id}/baseline": classScopedWrite,
		"GET /api/v1/shape-reference":              classScopedRead,
		"GET /api/v1/silences":                     classScopedRead,
		"POST /api/v1/silences":                    classScopedWrite,
		"DELETE /api/v1/silences/{id}":             classScopedWrite,
		"GET /api/v1/alert-events":                 classScopedRead,
